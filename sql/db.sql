...
insert into student (name, email) values ('José Pinhal', 'josepinhal@mail.com');
insert into student (name, email) values ('Tozé Brito', 'tozebrito@mail.com');
insert into student (name, email) values ('José Cid', 'josecid@mail.com');
